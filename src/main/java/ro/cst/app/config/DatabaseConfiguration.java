...
import ro.cst.app.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("ro.cst.app.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("ro.cst.app.repository.search")
